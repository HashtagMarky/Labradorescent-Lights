...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_JASMIGEIS] = gMonIcon_Jasmigeis,
    [SPECIES_MATCHAGEIS] = gMonIcon_Matchageis,
    [SPECIES_CHARCADET] = gMonIcon_Charcadet,
    [SPECIES_ARMOROUGE] = gMonIcon_Armorouge,
    [SPECIES_CERULEDGE] = gMonIcon_Ceruledge,
    [SPECIES_BASULIN] = gMonIcon_Basulin,
    [SPECIES_BASULEGION] = gMonIcon_Basulegion,
    [SPECIES_BASULEADER] = gMonIcon_Basuleader,
    [SPECIES_CARBINK] = gMonIcon_Ditto,
    [SPECIES_DIANCIE] = gMonIcon_Ditto,
    [SPECIES_CHIMCHAR] = gMonIcon_Ditto,
    [SPECIES_MONFERNO] = gMonIcon_Ditto,
    [SPECIES_INFERNAPE] = gMonIcon_Ditto,
    [SPECIES_BOLINBAT] = gMonIcon_Ditto,
    [SPECIES_NOCTEONIX] = gMonIcon_Ditto,
    [SPECIES_ESPURR] = gMonIcon_Ditto,
    [SPECIES_MEOWSTIC_MALE] = gMonIcon_Ditto,
    [SPECIES_MEOWSTIC_FEMALE] = gMonIcon_Ditto,
    [SPECIES_HAPPINEY] = gMonIcon_Ditto,
    [SPECIES_MIME_JR] = gMonIcon_Ditto,
    [SPECIES_BUDEW] = gMonIcon_Ditto,
    [SPECIES_ROSERADE] = gMonIcon_Ditto,
    [SPECIES_AMBIPOMB] = gMonIcon_Ditto,
    [SPECIES_DUNCEPARCE] = gMonIcon_Ditto,
    [SPECIES_PROBOPASS] = gMonIcon_Ditto,
    [SPECIES_OBSTAGOON] = gMonIcon_Ditto,
    [SPECIES_ELECTAVIRE] = gMonIcon_Ditto,
    [SPECIES_MAGMORTAR] = gMonIcon_Ditto,
    [SPECIES_QUEEN_ABSOL] = gMonIcon_Ditto,
};
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_SINISTEA] = 1,
    [SPECIES_JASMIGEIS] = 1,
    [SPECIES_MATCHAGEIS] = 1,
    [SPECIES_CHARCADET] = 0,
    [SPECIES_ARMOROUGE] = 0,
    [SPECIES_CERULEDGE] = 2,
    [SPECIES_BASULIN] = 1,
    [SPECIES_BASULEGION] = 1,
    [SPECIES_BASULEADER] = 1,
    [SPECIES_CARBINK] = 2,
    [SPECIES_DIANCIE] = 2,
    [SPECIES_CHIMCHAR] = 2,
    [SPECIES_MONFERNO] = 2,
    ...
    [SPECIES_NOCTEONIX] = 2,
    [SPECIES_ESPURR] = 2,
    [SPECIES_MEOWSTIC_MALE] = 2,
    [SPECIES_MEOWSTIC_FEMALE] = 2,
    [SPECIES_HAPPINEY] = 2,
    [SPECIES_MIME_JR] = 2,
    [SPECIES_BUDEW] = 2,
    [SPECIES_ROSERADE] = 2,
    [SPECIES_AMBIPOMB] = 2,
    [SPECIES_DUNCEPARCE] = 2,
    [SPECIES_PROBOPASS] = 2,
    [SPECIES_OBSTAGOON] = 2,
