...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    ANIM_CMD_BACK_DITTO(SINISTEA),
    ANIM_CMD_BACK_DITTO(JASMIGEIS),
    ANIM_CMD_BACK_DITTO(MATCHAGEIS),
    ANIM_CMD_BACK_DITTO(CHARCADET),
    ANIM_CMD_BACK_DITTO(ARMOROUGE),
    ANIM_CMD_BACK_DITTO(CERULEDGE),
    ANIM_CMD_BACK_DITTO(BASULIN),
    ANIM_CMD_BACK_DITTO(BASULEGION),
    ANIM_CMD_BACK_DITTO(BASULEADER),
