...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    ANIM_CMD_BACK_DITTO(CARBINK),
    ANIM_CMD_BACK_DITTO(DIANCIE),
    ANIM_CMD_BACK_DITTO(CHIMCHAR),
    ANIM_CMD_BACK_DITTO(MONFERNO),
    ANIM_CMD_BACK_DITTO(INFERNAPE),
    ANIM_CMD_BACK_DITTO(BOLINBAT),
    ANIM_CMD_BACK_DITTO(NOCTEONIX),
    ANIM_CMD_BACK_DITTO(ESPURR),
    ANIM_CMD_BACK_DITTO(MEOWSTIC_MALE),
    ANIM_CMD_BACK_DITTO(MEOWSTIC_FEMALE),
