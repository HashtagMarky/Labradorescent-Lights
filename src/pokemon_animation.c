...
#define ANIM_CMD_BACK_DITTO(name)             [SPECIES_##name] = BACK_ANIM_SHRINK_GROW
...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_QUEEN_ABSOL]      = BACK_ANIM_SHRINK_GROW_VIBRATE,
    ...
    [SPECIES_JASMIGEIS]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_MATCHAGEIS]= BACK_ANIM_H_VIBRATE,
    [SPECIES_CHARCADET]  = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_ARMOROUGE]  = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_CERULEDGE]  = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_BASULIN]    = BACK_ANIM_SHRINK_GROW,
    [SPECIES_BASULEGION] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_BASULEADER] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_CARBINK] = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_DIANCIE] = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_CHIMCHAR] = BACK_ANIM_H_SHAKE,
    [SPECIES_MONFERNO] BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_INFERNAPE] BACK_ANIM_SHAKE_GLOW_RED,
    ANIM_CMD_BACK_DITTO(BOLINBAT),
    ANIM_CMD_BACK_DITTO(NOCTEONIX),
    [SPECIES_ESPURR] BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_MEOWSTIC_MALE] BACK_ANIM_H_VIBRATE,
    [SPECIES_MEOWSTIC_FEMALE] BACK_ANIM_H_VIBRATE,
    ANIM_CMD_BACK_DITTO(HAPPINEY),
    ANIM_CMD_BACK_DITTO(MIME_JR),
    ANIM_CMD_BACK_DITTO(BUDEW),
    ANIM_CMD_BACK_DITTO(ROSERADE),
    ANIM_CMD_BACK_DITTO(AMBIPOMB),
    ANIM_CMD_BACK_DITTO(DUNCEPARCE),
    ANIM_CMD_BACK_DITTO(PROBOPASS),
    ANIM_CMD_BACK_DITTO(OBSTAGOON),
    ANIM_CMD_BACK_DITTO(ELECTAVIRE),
    ANIM_CMD_BACK_DITTO(MAGMORTAR),
};

#undef ANIM_CMD_BACK_DITTO
