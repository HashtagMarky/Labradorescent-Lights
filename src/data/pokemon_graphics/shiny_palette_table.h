const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BOLINBAT, gMonShinyPalette_Bolinbat),
    SPECIES_SHINY_PAL(NOCTEONIX, gMonShinyPalette_Nocteonix),
    ...
    SPECIES_SHINY_PAL(HAPPINEY, gMonShinyPalette_Happiney),
    ...
    SPECIES_SHINY_PAL(AMBIPOMB, gMonShinyPalette_Ambipomb),
    SPECIES_SHINY_PAL(DUNCEPARCE, gMonShinyPalette_Dunceparce),
    ...
    SPECIES_SHINY_PAL(QUEEN_ABSOL, gMonShinyPalette_QueenAbsol),
};
