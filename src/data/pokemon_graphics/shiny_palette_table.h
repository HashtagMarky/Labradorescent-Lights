const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(JASMIGEIS, gMonShinyPalette_Jasmigeis),
    SPECIES_SHINY_PAL(MATCHAGEIS, gMonShinyPalette_Matchageis),
    SPECIES_SHINY_PAL(CHARCADET, gMonShinyPalette_Charcadet),
    SPECIES_SHINY_PAL(ARMOROUGE, gMonShinyPalette_Armorouge),
    SPECIES_SHINY_PAL(CERULEDGE, gMonShinyPalette_Ceruledge),
    SPECIES_SHINY_PAL(BASULIN, gMonShinyPalette_Basulin),
    SPECIES_SHINY_PAL(BASULEGION, gMonShinyPalette_Basulegion),
    SPECIES_SHINY_PAL(BASULEADER, gMonShinyPalette_Basuleader),
    SPECIES_SHINY_PAL(CARBINK, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(DIANCIE, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(CHIMCHAR, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(MONFERNO, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(INFERNAPE, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(BOLINBAT, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(NOCTEONIX, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(ESPURR, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(MEOWSTIC_MALE, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(MEOWSTIC_FEMALE, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(HAPPINEY, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(MIME_JR, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(BUDEW, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(ROSERADE, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(AMBIPOMB, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(DUNCEPARCE, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(PROBOPASS, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(OBSTAGOON, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(ELECTAVIRE, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(MAGMORTAR, gMonShinyPalette_Ditto),
    SPECIES_SHINY_PAL(QUEEN_ABSOL, gMonShinyPalette_Ditto),
};
