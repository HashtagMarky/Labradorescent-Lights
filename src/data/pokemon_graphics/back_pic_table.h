const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BOLINBAT, gMonBackPic_Bolinbat),
    SPECIES_SPRITE(NOCTEONIX, gMonBackPic_Nocteonix),
    ...
    SPECIES_SPRITE(HAPPINEY, gMonBackPic_Happiney),
    ...
    SPECIES_SPRITE(AMBIPOMB, gMonBackPic_Ambipomb),
    SPECIES_SPRITE(DUNCEPARCE, gMonBackPic_Dunceparce),
    ...
    SPECIES_SPRITE(QUEEN_ABSOL, gMonBackPic_QueenAbsol),
};
