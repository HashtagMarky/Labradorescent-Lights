const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(JASMIGEIS, gMonBackPic_Jasmigeis),
    SPECIES_SPRITE(MATCHAGEIS, gMonBackPic_Matchageis),
    SPECIES_SPRITE(CHARCADET, gMonBackPic_Charcadet),
    SPECIES_SPRITE(ARMOROUGE, gMonBackPic_Armorouge),
    SPECIES_SPRITE(CERULEDGE, gMonBackPic_Ceruledge),
    SPECIES_SPRITE(BASULIN, gMonBackPic_Basulin),
    SPECIES_SPRITE(BASULEGION, gMonBackPic_Basulegion),
    SPECIES_SPRITE(BASULEADER, gMonBackPic_Basuleader),
    SPECIES_SPRITE(CARBINK, gMonBackPic_Ditto),
    SPECIES_SPRITE(DIANCIE, gMonBackPic_Ditto),
    SPECIES_SPRITE(CHIMCHAR, gMonBackPic_Ditto),
    SPECIES_SPRITE(MONFERNO, gMonBackPic_Ditto),
    SPECIES_SPRITE(INFERNAPE, gMonBackPic_Ditto),
    SPECIES_SPRITE(BOLINBAT, gMonBackPic_Ditto),
    SPECIES_SPRITE(NOCTEONIX, gMonBackPic_Ditto),
    SPECIES_SPRITE(ESPURR, gMonBackPic_Ditto),
    SPECIES_SPRITE(MEOWSTIC_MALE, gMonBackPic_Ditto),
    SPECIES_SPRITE(MEOWSTIC_FEMALE, gMonBackPic_Ditto),
    SPECIES_SPRITE(HAPPINEY, gMonBackPic_Ditto),
    SPECIES_SPRITE(MIME_JR, gMonBackPic_Ditto),
    SPECIES_SPRITE(BUDEW, gMonBackPic_Ditto),
    SPECIES_SPRITE(ROSERADE, gMonBackPic_Ditto),
    SPECIES_SPRITE(AMBIPOMB, gMonBackPic_Ditto),
    SPECIES_SPRITE(DUNCEPARCE, gMonBackPic_Ditto),
    SPECIES_SPRITE(PROBOPASS, gMonBackPic_Ditto),
    SPECIES_SPRITE(OBSTAGOON, gMonBackPic_Ditto),
    SPECIES_SPRITE(ELECTAVIRE, gMonBackPic_Ditto),
    SPECIES_SPRITE(MAGMORTAR, gMonBackPic_Ditto),
    SPECIES_SPRITE(QUEEN_ABSOL, gMonBackPic_Ditto),
};
