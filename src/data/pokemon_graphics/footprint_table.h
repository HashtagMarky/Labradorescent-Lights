const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_JASMIGEIS] = gMonFootprint_Jasmigeis,
    [SPECIES_MATCHAGEIS] = gMonFootprint_Matchageis,
    [SPECIES_CHARCADET] = gMonFootprint_Charcadet,
    [SPECIES_ARMOROUGE] = gMonFootprint_Armorouge,
    [SPECIES_CERULEDGE] = gMonFootprint_Ceruledge,
    [SPECIES_BASULIN] = gMonFootprint_Basulin,
    [SPECIES_BASULEGION] = gMonFootprint_Basulegion,
    [SPECIES_BASULEADER] = gMonFootprint_Basuleader,
    [SPECIES_CARBINK] = gMonFootprint_Ditto,
    [SPECIES_DIANCIE] = gMonFootprint_Ditto,
    [SPECIES_CHIMCHAR] = gMonFootprint_Ditto,
    [SPECIES_MONFERNO] = gMonFootprint_Ditto,
    [SPECIES_INFERNAPE] = gMonFootprint_Ditto,
    [SPECIES_BOLINBAT] = gMonFootprint_Ditto,
    [SPECIES_NOCTEONIX] = gMonFootprint_Ditto,
    [SPECIES_ESPURR] = gMonFootprint_Ditto,
    [SPECIES_MEOWSTIC_MALE] = gMonFootprint_Ditto,
    [SPECIES_MEOWSTIC_FEMALE] = gMonFootprint_Ditto,
    [SPECIES_HAPPINEY] = gMonFootprint_Ditto,
    [SPECIES_MIME_JR] = gMonFootprint_Ditto,
    [SPECIES_BUDEW] = gMonFootprint_Ditto,
    [SPECIES_ROSERADE] = gMonFootprint_Ditto,
    [SPECIES_AMBIPOMB] = gMonFootprint_Ditto,
    [SPECIES_DUNCEPARCE] = gMonFootprint_Ditto,
    [SPECIES_PROBOPASS] = gMonFootprint_Ditto,
    [SPECIES_OBSTAGOON] = gMonFootprint_Ditto,
    [SPECIES_ELECTAVIRE] = gMonFootprint_Ditto,
    [SPECIES_MAGMORTAR] = gMonFootprint_Ditto,
    [SPECIES_QUEEN_ABSOL] = gMonFootprint_Ditto,
    //
