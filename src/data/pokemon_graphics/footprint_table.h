const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_BOLINBAT] = gMonFootprint_Bolinbat,
    [SPECIES_NOCTEONIX] = gMonFootprint_Nocteonix,
    [SPECIES_ESPURR] = gMonFootprint_Espurr,
    [SPECIES_MEOWSTIC_MALE] = gMonFootprint_MeowsticMale,
    [SPECIES_MEOWSTIC_FEMALE] = gMonFootprint_MeowsticFemale,
    [SPECIES_HAPPINEY] = gMonFootprint_Happiney,
    [SPECIES_MIME_JR] = gMonFootprint_MimeJr,
    [SPECIES_BUDEW] = gMonFootprint_Budew,
    [SPECIES_ROSERADE] = gMonFootprint_Roserade,
    [SPECIES_AMBIPOMB] = gMonFootprint_Ambipomb,
    [SPECIES_DUNCEPARCE] = gMonFootprint_Dunceparce,
    ...
    [SPECIES_QUEEN_ABSOL] = gMonFootprint_QueenAbsol,
    //
