...
// LAB. LIGHTS
#define ANIM_CMD_DITTO(name)             [SPECIES_##name] = sAnims_DITTO
...
// LAB. LIGHTS
    ...
    ANIM_CMD_DITTO(ROSERADE),
    ANIM_CMD_DITTO(AMBIPOMB),
    ANIM_CMD_DITTO(DUNCEPARCE),
    ANIM_CMD_DITTO(PROBOPASS),
