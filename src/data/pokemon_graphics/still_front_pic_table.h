...
// Gen III
    ...
    SPECIES_SPRITE(JASMIGEIS, gMonStillFrontPic_Jasmigeis),
    SPECIES_SPRITE(MATCHAGEIS, gMonStillFrontPic_Matchageis),
    SPECIES_SPRITE(CHARCADET, gMonStillFrontPic_Charcadet),
    SPECIES_SPRITE(ARMOROUGE, gMonStillFrontPic_Armorouge),
    SPECIES_SPRITE(CERULEDGE, gMonStillFrontPic_Ceruledge),
    SPECIES_SPRITE(BASULIN, gMonStillFrontPic_Basulin),
    SPECIES_SPRITE(BASULEGION, gMonStillFrontPic_Basulegion),
    SPECIES_SPRITE(BASULEADER, gMonStillFrontPic_Basuleader),
