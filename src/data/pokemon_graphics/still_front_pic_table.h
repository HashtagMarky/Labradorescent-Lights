...
// Gen III
    ...
    SPECIES_SPRITE(CARBINK, gMonStillFrontPic_Carbink),
    ...
    SPECIES_SPRITE(BOLINBAT, gMonStillFrontPic_Bolinbat),
    SPECIES_SPRITE(NOCTEONIX, gMonStillFrontPic_Nocteonix),
    SPECIES_SPRITE(ESPURR, gMonStillFrontPic_Espurr),
    SPECIES_SPRITE(MEOWSTIC_MALE, gMonStillFrontPic_MeowsticMale),
    SPECIES_SPRITE(MEOWSTIC_FEMALE, gMonStillFrontPic_MeowsticFemale),
    SPECIES_SPRITE(HAPPINEY, gMonStillFrontPic_Happiney),
    ...
    SPECIES_SPRITE(AMBIPOMB, gMonStillFrontPic_Ambipomb),
    SPECIES_SPRITE(DUNCEPARCE, gMonStillFrontPic_Dunceparce),
    SPECIES_SPRITE(PROBOPASS, gMonStillFrontPic_Probopass),
    SPECIES_SPRITE(OBSTAGOON, gMonStillFrontPic_Obstagoon),
    SPECIES_SPRITE(ELECTAVIRE, gMonStillFrontPic_Electavire),
    SPECIES_SPRITE(MAGMORTAR, gMonStillFrontPic_Magmortar),
    SPECIES_SPRITE(QUEEN_ABSOL, gMonStillFrontPic_QueenAbsol),
};
