...
// Gen III
    ...
    SPECIES_SPRITE(SINISTEA, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(JASMIGEIS, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(MATCHAGEIS, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(CHARCADET, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(ARMOROUGE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(CERULEDGE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(BASULIN, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(BASULEGION, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(BASULEADER, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(CARBINK, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(DIANCIE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(CHIMCHAR, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(MONFERNO, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(INFERNAPE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(BOLINBAT, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(NOCTEONIX, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(ESPURR, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(MEOWSTIC_MALE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(MEOWSTIC_FEMALE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(HAPPINEY, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(MIME_JR, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(BUDEW, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(ROSERADE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(AMBIPOMB, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(DUNCEPARCE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(PROBOPASS, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(OBSTAGOON, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(ELECTAVIRE, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(MAGMORTAR, gMonStillFrontPic_Ditto),
    SPECIES_SPRITE(QUEEN_ABSOL, gMonStillFrontPic_Ditto),
};
