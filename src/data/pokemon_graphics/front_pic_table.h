const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BOLINBAT, gMonFrontPic_Bolinbat),
    SPECIES_SPRITE(NOCTEONIX, gMonFrontPic_Nocteonix),
    ...
    SPECIES_SPRITE(HAPPINEY, gMonFrontPic_Happiney),
    ...
    SPECIES_SPRITE(AMBIPOMB, gMonFrontPic_Ambipomb),
    SPECIES_SPRITE(DUNCEPARCE, gMonFrontPic_Dunceparce),
    ...
    SPECIES_SPRITE(QUEEN_ABSOL, gMonFrontPic_QueenAbsol),
};
