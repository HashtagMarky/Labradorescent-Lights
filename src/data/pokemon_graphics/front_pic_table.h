const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(JASMIGEIS, gMonFrontPic_Jasmigeis),
    SPECIES_SPRITE(MATCHAGEIS, gMonFrontPic_Matchageis),
    SPECIES_SPRITE(CHARCADET, gMonFrontPic_Charcadet),
    SPECIES_SPRITE(ARMOROUGE, gMonFrontPic_Armorouge),
    SPECIES_SPRITE(CERULEDGE, gMonFrontPic_Ceruledge),
    SPECIES_SPRITE(BASULIN, gMonFrontPic_Basulin),
    SPECIES_SPRITE(BASULEGION, gMonFrontPic_Basulegion),
    SPECIES_SPRITE(BASULEADER, gMonFrontPic_Basuleader),
