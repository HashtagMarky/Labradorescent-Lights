const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(SINISTEA, gMonFrontPic_Ditto),
    SPECIES_SPRITE(JASMIGEIS, gMonFrontPic_Ditto),
    SPECIES_SPRITE(MATCHAGEIS, gMonFrontPic_Ditto),
    SPECIES_SPRITE(CHARCADET, gMonFrontPic_Ditto),
    SPECIES_SPRITE(ARMOROUGE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(CERULEDGE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(BASULIN, gMonFrontPic_Ditto),
    SPECIES_SPRITE(BASULEGION, gMonFrontPic_Ditto),
    SPECIES_SPRITE(BASULEADER, gMonFrontPic_Ditto),
    SPECIES_SPRITE(CARBINK, gMonFrontPic_Ditto),
    SPECIES_SPRITE(DIANCIE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(CHIMCHAR, gMonFrontPic_Ditto),
    SPECIES_SPRITE(MONFERNO, gMonFrontPic_Ditto),
    SPECIES_SPRITE(INFERNAPE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(BOLINBAT, gMonFrontPic_Ditto),
    SPECIES_SPRITE(NOCTEONIX, gMonFrontPic_Ditto),
    SPECIES_SPRITE(ESPURR, gMonFrontPic_Ditto),
    SPECIES_SPRITE(MEOWSTIC_MALE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(MEOWSTIC_FEMALE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(HAPPINEY, gMonFrontPic_Ditto),
    SPECIES_SPRITE(MIME_JR, gMonFrontPic_Ditto),
    SPECIES_SPRITE(BUDEW, gMonFrontPic_Ditto),
    SPECIES_SPRITE(ROSERADE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(AMBIPOMB, gMonFrontPic_Ditto),
    SPECIES_SPRITE(DUNCEPARCE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(PROBOPASS, gMonFrontPic_Ditto),
    SPECIES_SPRITE(OBSTAGOON, gMonFrontPic_Ditto),
    SPECIES_SPRITE(ELECTAVIRE, gMonFrontPic_Ditto),
    SPECIES_SPRITE(MAGMORTAR, gMonFrontPic_Ditto),
    SPECIES_SPRITE(QUEEN_ABSOL, gMonFrontPic_Ditto),
};
