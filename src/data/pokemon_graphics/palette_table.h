const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(JASMIGEIS, gMonPalette_Jasmigeis),
    SPECIES_PAL(MATCHAGEIS, gMonPalette_Matchageis),
    SPECIES_PAL(CHARCADET, gMonPalette_Charcadet),
    SPECIES_PAL(ARMOROUGE, gMonPalette_Armorouge),
    SPECIES_PAL(CERULEDGE, gMonPalette_Ceruledge),
    SPECIES_PAL(BASULIN, gMonPalette_Basulin),
    SPECIES_PAL(BASULEGION, gMonPalette_Basulegion),
    SPECIES_PAL(BASULEADER, gMonPalette_Basuleader),
    SPECIES_PAL(CARBINK, gMonPalette_Ditto),
    SPECIES_PAL(DIANCIE, gMonPalette_Ditto),
    SPECIES_PAL(CHIMCHAR, gMonPalette_Ditto),
    SPECIES_PAL(MONFERNO, gMonPalette_Ditto),
    SPECIES_PAL(INFERNAPE, gMonPalette_Ditto),
    SPECIES_PAL(BOLINBAT, gMonPalette_Ditto),
    SPECIES_PAL(NOCTEONIX, gMonPalette_Ditto),
    SPECIES_PAL(ESPURR, gMonPalette_Ditto),
    SPECIES_PAL(MEOWSTIC_MALE, gMonPalette_Ditto),
    SPECIES_PAL(MEOWSTIC_FEMALE, gMonPalette_Ditto),
    SPECIES_PAL(HAPPINEY, gMonPalette_Ditto),
    SPECIES_PAL(MIME_JR, gMonPalette_Ditto),
    SPECIES_PAL(BUDEW, gMonPalette_Ditto),
    SPECIES_PAL(ROSERADE, gMonPalette_Ditto),
    SPECIES_PAL(AMBIPOMB, gMonPalette_Ditto),
    SPECIES_PAL(DUNCEPARCE, gMonPalette_Ditto),
    SPECIES_PAL(PROBOPASS, gMonPalette_Ditto),
    SPECIES_PAL(OBSTAGOON, gMonPalette_Ditto),
    SPECIES_PAL(ELECTAVIRE, gMonPalette_Ditto),
    SPECIES_PAL(MAGMORTAR, gMonPalette_Ditto),
    SPECIES_PAL(QUEEN_ABSOL, gMonPalette_Ditto),
};
