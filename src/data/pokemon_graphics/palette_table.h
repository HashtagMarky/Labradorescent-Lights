const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BOLINBAT, gMonPalette_Bolinbat),
    SPECIES_PAL(NOCTEONIX, gMonPalette_Nocteonix),
    ...
    SPECIES_PAL(HAPPINEY, gMonPalette_Happiney),
    SPECIES_PAL(MIME_JR, gMonPalette_MimeJr),
    SPECIES_PAL(BUDEW, gMonPalette_Budew),
    SPECIES_PAL(ROSERADE, gMonPalette_Roserade),
    SPECIES_PAL(AMBIPOMB, gMonPalette_Ambipomb),
    SPECIES_PAL(DUNCEPARCE, gMonPalette_Dunceparce),
    ...
    SPECIES_PAL(QUEEN_ABSOL, gMonPalette_QueenAbsol),
};
