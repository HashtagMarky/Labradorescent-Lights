...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_MOVE2(BARRAGE),
    EC_MOVE2(BARRIER),
    EC_POKEMON_NATIONAL(BASULEADER),
    EC_POKEMON_NATIONAL(BASULEGION),
    EC_POKEMON_NATIONAL(BASULIN),
    EC_WORD_BATH,
    EC_MOVE2(BATON_PASS),
    EC_WORD_BATTLE,
...
const u16 gEasyChatWordsByLetter_M[] = {
    ...
    EC_WORD_MATCH,
    EC_WORD_MATCH_UP,
    EC_POKEMON_NATIONAL(MATCHAGEIS),
    EC_POKEMON(MAWILE),
    EC_WORD_MAYBE,
    EC_WORD_MC,
    EC_WORD_ME,
