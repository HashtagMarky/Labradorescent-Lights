const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_AQUA_GRUNT_DOUBLES] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(AQUA_GRUNT_DOUBLES, gTrainerFrontPic_AquaGruntDoubles, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(AQUA_GRUNT_DOUBLES, gTrainerPalette_AquaGruntM),
};
