...
const u32 gTrainerPalette_RubySapphireBrendan[] = INCBIN_U32("graphics/trainers/palettes/parents.gbapal.lz");
...
const u8 gTrainerBackPic_RubySapphireBrendan[] = INCBIN_U8("graphics/trainers/back_pics/parents_back_pic.4bpp");
...
const u32 gTrainerFrontPic_AquaGruntDoubles[] = INCBIN_U32("graphics/trainers/front_pics/aqua_grunt_doubles_front_pic.4bpp.lz");
