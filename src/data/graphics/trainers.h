...
const u32 gTrainerFrontPic_Brendan[] = INCBIN_U32("graphics/trainers/front_pics/leader_norman_front_pic.4bpp.lz");
const u32 gTrainerPalette_Brendan[] = INCBIN_U32("graphics/trainers/palettes/leader_norman.gbapal.lz");

const u32 gTrainerFrontPic_May[] = INCBIN_U32("graphics/trainers/front_pics/mom_front_pic.4bpp.lz");
const u32 gTrainerPalette_May[] = INCBIN_U32("graphics/trainers/palettes/mom.gbapal.lz");
