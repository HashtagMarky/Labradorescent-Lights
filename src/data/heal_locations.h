...
{
    [HEAL_LOCATION_BOREA_GLADE_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(BOREA_GLADE_BRENDANS_HOUSE_2F), MAP_NUM(BOREA_GLADE_BRENDANS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_BOREA_GLADE_MAYS_HOUSE_2F - 1] = {MAP_GROUP(BOREA_GLADE_MAYS_HOUSE_2F), MAP_NUM(BOREA_GLADE_MAYS_HOUSE_2F), 4, 2},
    ...
    [HEAL_LOCATION_BOREA_GLADE_BRENDANS_HOUSE - 1] = {MAP_GROUP(BOREA_GLADE), MAP_NUM(BOREA_GLADE), 5, 9},
    [HEAL_LOCATION_BOREA_GLADE_MAYS_HOUSE - 1] = {MAP_GROUP(BOREA_GLADE), MAP_NUM(BOREA_GLADE), 14, 9},
    ...
    [HEAL_LOCATION_ROUTE_103_MOUNTAINS - 1] = {MAP_GROUP(ROUTE103MOUNTAINS), MAP_NUM(ROUTE103MOUNTAINS), 7, 21},
    [HEAL_LOCATION_PETALBURG_CITY_AQUA - 1] = {MAP_GROUP(PETALBURG_CITY_AQUA), MAP_NUM(PETALBURG_CITY_AQUA), 15, 9},
};
