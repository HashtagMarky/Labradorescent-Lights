const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_JASMIGEIS] = _("JASMIGEIS"),
    [SPECIES_MATCHAGEIS] = _("MATCHAGEIS"),
    [SPECIES_CHARCADET] = _("CHARCADET"),
    [SPECIES_ARMOROUGE] = _("ARMOROUGE"),
    [SPECIES_CERULEDGE] = _("CEURULEDGE"),
    [SPECIES_BASULIN] = _("BASULIN"),
    [SPECIES_BASULEGION] = _("BASULEGION"),
    [SPECIES_BASULEADER] = _("BASULEADER"),
