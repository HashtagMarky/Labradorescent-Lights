const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    // Labradorescent Lights
    [SPECIES_SINISTEA]   = {{EVO_ITEM, ITEM_ALTERNATE_STONE, SPECIES_JASMIGEIS},
                            {EVO_ITEM, ITEM_GHOUL_STONE, SPECIES_MATCHAGEIS}},
    [SPECIES_CHARCADET]  = {{EVO_ITEM, ITEM_ALTERNATE_STONE, SPECIES_ARMOROUGE},
                            {EVO_ITEM, ITEM_GHOUL_STONE, SPECIES_CERULEDGE}},
    [SPECIES_BASULIN]    = {{EVO_ITEM, ITEM_ALTERNATE_STONE, SPECIES_BASULEGION},
                            {EVO_ITEM, ITEM_GHOUL_STONE, SPECIES_BASULEADER}},
    [SPECIES_CARBINK]    = {{EVO_FRIENDSHIP_FEMALE, 0, SPECIES_DIANCIE}},
    [SPECIES_CHIMCHAR]   = {{EVO_LEVEL, 16, SPECIES_MONFERNO}},
    [SPECIES_MONFERNO]   = {{EVO_LEVEL, 36, SPECIES_INFERNAPE}},

    [SPECIES_ESPURR]     = {{EVO_FRIENDSHIP_FEMALE, 0, SPECIES_MEOWSTIC_FEMALE},
                            {EVO_FRIENDSHIP_MALE, 0, SPECIES_MEOWSTIC_MALE}},
};
