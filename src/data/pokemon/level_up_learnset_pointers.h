const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_JASMIGEIS] = sJasmigeisLevelUpLearnset,
    [SPECIES_MATCHAGEIS] = sMatchageisLevelUpLearnset,
    [SPECIES_CHARCADET] = sCharcadetLevelUpLearnset,
    [SPECIES_ARMOROUGE] = sArmorougeLevelUpLearnset,
    [SPECIES_CERULEDGE] = sCeruledgeLevelUpLearnset,
    [SPECIES_BASULIN] = sBasulinLevelUpLearnset,
    [SPECIES_BASULEGION] = sBasulegionLevelUpLearnset,
    [SPECIES_BASULEADER] = sBasuleaderLevelUpLearnset,
