const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_SINISTEA] = sDittoLevelUpLearnset,
    [SPECIES_JASMIGEIS] = sDittoLevelUpLearnset,
    [SPECIES_MATCHAGEIS] = sDittoLevelUpLearnset,
    [SPECIES_CHARCADET] = sDittoLevelUpLearnset,
    [SPECIES_ARMOROUGE] = sDittoLevelUpLearnset,
    [SPECIES_CERULEDGE] = sDittoLevelUpLearnset,
    [SPECIES_BASULIN] = sDittoLevelUpLearnset,
    [SPECIES_BASULEGION] = sDittoLevelUpLearnset,
    [SPECIES_BASULEADER] = sDittoLevelUpLearnset,
    [SPECIES_CARBINK] = sDittoLevelUpLearnset,
    [SPECIES_DIANCIE] = sDittoLevelUpLearnset,
    [SPECIES_CHIMCHAR] = sDittoLevelUpLearnset,
    [SPECIES_MONFERNO] = sDittoLevelUpLearnset,
    [SPECIES_INFERNAPE] = sDittoLevelUpLearnset,
    [SPECIES_BOLINBAT] = sDittoLevelUpLearnset,
    [SPECIES_NOCTEONIX] = sDittoLevelUpLearnset,
    [SPECIES_ESPURR] = sDittoLevelUpLearnset,
    [SPECIES_MEOWSTIC_MALE] = sDittoLevelUpLearnset,
    [SPECIES_MEOWSTIC_FEMALE] = sDittoLevelUpLearnset,
    [SPECIES_HAPPINEY] = sDittoLevelUpLearnset,
    [SPECIES_MIME_JR] = sDittoLevelUpLearnset,
    [SPECIES_BUDEW] = sDittoLevelUpLearnset,
    [SPECIES_ROSERADE] = sDittoLevelUpLearnset,
    [SPECIES_AMBIPOMB] = sDittoLevelUpLearnset,
    [SPECIES_DUNCEPARCE] = sDittoLevelUpLearnset,
    [SPECIES_PROBOPASS] = sDittoLevelUpLearnset,
    [SPECIES_OBSTAGOON] = sDittoLevelUpLearnset,
    [SPECIES_ELECTAVIRE] = sDittoLevelUpLearnset,
    [SPECIES_MAGMORTAR] = sDittoLevelUpLearnset,
};
