...
const u32 gMonFrontPic_Jasmigeis[] = INCBIN_U32("graphics/pokemon/jasmigeis/anim_front.4bpp.lz");
const u32 gMonFrontPic_Matchageis[] = INCBIN_U32("graphics/pokemon/matchageis/anim_front.4bpp.lz");
const u32 gMonFrontPic_Charcadet[] = INCBIN_U32("graphics/pokemon/charcadet/anim_front.4bpp.lz");
const u32 gMonFrontPic_Armorouge[] = INCBIN_U32("graphics/pokemon/armorouge/anim_front.4bpp.lz");
...
const u32 gMonFrontPic_Basulegion[] = INCBIN_U32("graphics/pokemon/basulegion/anim_front.4bpp.lz");
const u32 gMonFrontPic_Basuleader[] = INCBIN_U32("graphics/pokemon/basuleader/anim_front.4bpp.lz");
const u32 gMonFrontPic_Carbink[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Diancie[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Chimchar[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Monferno[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Infernape[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Bolinbat[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Nocteonix[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Espurr[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_MeowsticMale[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_MeowsticFemale[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Happiney[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_MimeJr[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Budew[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Roserade[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Ambipomb[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Dunceparce[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
const u32 gMonFrontPic_Probopass[] = INCBIN_U32("graphics/pokemon/ditto/anim_front.4bpp.lz");
