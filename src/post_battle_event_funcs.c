...
int GameClear(void)
{
    ...
    if (gSaveBlock2Ptr->playerGender == MALE)
        SetContinueGameWarpToHealLocation(HEAL_LOCATION_BOREA_GLADE_BRENDANS_HOUSE_2F);
    else
        SetContinueGameWarpToHealLocation(HEAL_LOCATION_BOREA_GLADE_MAYS_HOUSE_2F);
