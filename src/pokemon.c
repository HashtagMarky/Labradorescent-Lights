...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    ANIM_CMD_FRONT_DITTO(JASMIGEIS),
    ANIM_CMD_FRONT_DITTO(MATCHAGEIS),
    [SPECIES_CHARCADET - 1]   = ANIM_FLASH_YELLOW,
    ANIM_CMD_FRONT_DITTO(ARMOROUGE),
    ANIM_CMD_FRONT_DITTO(CERULEDGE),
    [SPECIES_BASULIN - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    ANIM_CMD_FRONT_DITTO(BASULEGION),
    ANIM_CMD_FRONT_DITTO(BASULEADER),
