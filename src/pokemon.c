...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    ANIM_CMD_FRONT_DITTO(CARBINK),
    ANIM_CMD_FRONT_DITTO(DIANCIE),
    ANIM_CMD_FRONT_DITTO(CHIMCHAR),
    ANIM_CMD_FRONT_DITTO(MONFERNO),
    ANIM_CMD_FRONT_DITTO(INFERNAPE),
    ANIM_CMD_FRONT_DITTO(BOLINBAT),
    ANIM_CMD_FRONT_DITTO(NOCTEONIX),
    ANIM_CMD_FRONT_DITTO(ESPURR),
    ANIM_CMD_FRONT_DITTO(MEOWSTIC_MALE),
    ANIM_CMD_FRONT_DITTO(MEOWSTIC_FEMALE),
