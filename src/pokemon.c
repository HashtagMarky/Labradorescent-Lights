...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_QUEEN_ABSOL - 1] = HOENN_DEX_ABSOL,
    ...
    SPECIES_TO_HOENN(JASMIGEIS),
    SPECIES_TO_HOENN(MATCHAGEIS),
    SPECIES_TO_HOENN(CHARCADET),
    SPECIES_TO_HOENN(ARMOROUGE),
    SPECIES_TO_HOENN(CERULEDGE),
    SPECIES_TO_HOENN(BASULIN),
    SPECIES_TO_HOENN(BASULEGION),
    SPECIES_TO_HOENN(BASULEADER),
    ...
    SPECIES_TO_HOENN(BOLINBAT),
    SPECIES_TO_HOENN(NOCTEONIX),
    SPECIES_TO_HOENN(ESPURR),
    SPECIES_TO_HOENN(MEOWSTIC_MALE),
    SPECIES_TO_HOENN(MEOWSTIC_FEMALE),
    SPECIES_TO_HOENN(HAPPINEY),
    SPECIES_TO_HOENN(MIME_JR),
    SPECIES_TO_HOENN(BUDEW),
    SPECIES_TO_HOENN(ROSERADE),
    SPECIES_TO_HOENN(AMBIPOMB),
    SPECIES_TO_HOENN(DUNCEPARCE),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_QUEEN_ABSOL - 1] = NATIONAL_DEX_ABSOL,
    ...
    SPECIES_TO_NATIONAL(JASMIGEIS),
    SPECIES_TO_NATIONAL(MATCHAGEIS),
    SPECIES_TO_NATIONAL(CHARCADET),
    SPECIES_TO_NATIONAL(ARMOROUGE),
    SPECIES_TO_NATIONAL(CERULEDGE),
    SPECIES_TO_NATIONAL(BASULIN),
    SPECIES_TO_NATIONAL(BASULEGION),
    SPECIES_TO_NATIONAL(BASULEADER),
    ...
    SPECIES_TO_NATIONAL(BOLINBAT),
    SPECIES_TO_NATIONAL(NOCTEONIX),
    SPECIES_TO_NATIONAL(ESPURR),
    SPECIES_TO_NATIONAL(MEOWSTIC_MALE),
    SPECIES_TO_NATIONAL(MEOWSTIC_FEMALE),
    SPECIES_TO_NATIONAL(HAPPINEY),
    SPECIES_TO_NATIONAL(MIME_JR),
    SPECIES_TO_NATIONAL(BUDEW),
    SPECIES_TO_NATIONAL(ROSERADE),
    SPECIES_TO_NATIONAL(AMBIPOMB),
    SPECIES_TO_NATIONAL(DUNCEPARCE),
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(JASMIGEIS),
    HOENN_TO_NATIONAL(MATCHAGEIS),
    HOENN_TO_NATIONAL(CHARCADET),
    HOENN_TO_NATIONAL(ARMOROUGE),
    HOENN_TO_NATIONAL(CERULEDGE),
    HOENN_TO_NATIONAL(BASULIN),
    HOENN_TO_NATIONAL(BASULEGION),
    HOENN_TO_NATIONAL(BASULEADER),
    ...
    HOENN_TO_NATIONAL(BOLINBAT),
    HOENN_TO_NATIONAL(NOCTEONIX),
    HOENN_TO_NATIONAL(ESPURR),
    HOENN_TO_NATIONAL(MEOWSTIC_MALE),
    HOENN_TO_NATIONAL(MEOWSTIC_FEMALE),
    HOENN_TO_NATIONAL(HAPPINEY),
    HOENN_TO_NATIONAL(MIME_JR),
    HOENN_TO_NATIONAL(BUDEW),
    HOENN_TO_NATIONAL(ROSERADE),
    HOENN_TO_NATIONAL(AMBIPOMB),
    HOENN_TO_NATIONAL(DUNCEPARCE),
...
#define ANIM_CMD_FRONT_DITTO(name)             [SPECIES_##name - 1] = ANIM_CIRCULAR_STRETCH_TWICE
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_QUEEN_ABSOL - 1] = ANIM_CIRCULAR_VIBRATE,
    ...
    [SPECIES_SINISTEA - 1]    = ANIM_H_SHAKE,
    [SPECIES_JASMIGEIS - 1]   = ANIM_H_SHAKE,
    [SPECIES_MATCHAGEIS - 1]  = ANIM_H_SHAKE,
    [SPECIES_CHARCADET - 1]   = ANIM_FLASH_YELLOW,
    [SPECIES_ARMOROUGE - 1]   = ANIM_FLASH_YELLOW,
    [SPECIES_CERULEDGE - 1]   = ANIM_GLOW_BLUE,
    [SPECIES_BASULIN - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BASULEGION - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BASULEADER - 1]  = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CARBINK - 1] = ANIM_H_DIP,
    [SPECIES_DIANCIE - 1] = ANIM_H_DIP_TWICE,
    [SPECIES_CHIMCHAR - 1] = ANIM_V_JUMPS_BIG,
    [SPECIES_MONFERNO - 1] = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_INFERNAPE - 1] = ANIM_H_VIBRATE_FASTEST,
    ANIM_CMD_FRONT_DITTO(BOLINBAT),
    ANIM_CMD_FRONT_DITTO(NOCTEONIX),
    [SPECIES_ESPURR - 1] = ANIM_FLICKER,
    [SPECIES_MEOWSTIC_MALE - 1] = ANIM_FLICKER_INCREASING,
    [SPECIES_MEOWSTIC_FEMALE - 1] = ANIM_FLICKER_INCREASING,
    ANIM_CMD_FRONT_DITTO(HAPPINEY),
    ANIM_CMD_FRONT_DITTO(MIME_JR),
    ANIM_CMD_FRONT_DITTO(BUDEW),
    ANIM_CMD_FRONT_DITTO(ROSERADE),
    ANIM_CMD_FRONT_DITTO(AMBIPOMB),
    ANIM_CMD_FRONT_DITTO(DUNCEPARCE),
    ANIM_CMD_FRONT_DITTO(PROBOPASS),
    ANIM_CMD_FRONT_DITTO(OBSTAGOON),
    ANIM_CMD_FRONT_DITTO(ELECTAVIRE),
    ANIM_CMD_FRONT_DITTO(MAGMORTAR),
};

#undef ANIM_CMD_FRONT_DITTO
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (attacker->ability == ABILITY_HUSTLE)
        attack = (150 * attack) / 100;
    if (attacker->ability == ABILITY_BAD_OMEN)
        attack = (150 * attack) / 100;
        spAttack = (150 * spAttack) / 100;
...
#define IS_LEAGUE_BATTLE                                                                \
    ...
    && (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_ELITE_FOUR    \
     ...
     || gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_PKMN_MASTER   \
