...
const u8 gText_SideQuestName_10[] = _("MR. STONE's Delivery");
...
const u8 gText_SideQuestDesc_10[] = _("Delivery a letter to STEVEN\nfrom the head of the DEVON\n CORP, MR. STONE.");
...
const u8 gText_SideQuestDoneDesc_10[] = _("You've delivered the letter for MR.\n STONE, in return you received the\n EXP. SHARE!");
