...
const u8 gText_ThatsYourLastPkmn[] = _("Can't release this POKéMON!");
...
const u8 gText_SideQuestDesc_13[] = _("Now you've met GABBY and TY, battle\nwith them and show the world your\ntalent. Complete the BIG INTERVIEW!");
...
const u8 gText_SideQuestDoneDesc_4[] = _("After proving that QUEEN ABSOL isn't\na danger, but just a messenger, she\nhas joined you in protecting HOENN.");
