...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("ASA");
const u8 gText_ExpandedPlaceholder_May[] = _("ARIA");
const u8 gText_EggNickname[] = _("EGG");
const u8 gText_Pokemon[] = _("POKéMON");
const u8 gText_ProfBirchMatchCallName[] = _("IGNATIUS");
...
const u8 gText_BirchBoy[] = _("ASA");
const u8 gText_BirchGirl[] = _("ARIA");
const u8 gText_DefaultMaleName[] = _("ASA");
const u8 gText_DefaultFemaleName[] = _("ARIA");
...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. IGNATIUS' POKéDEX rating!\pPROF. IGNATIUS: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. IGNATIUS is in trouble!\nRelease a POKéMON and rescue him!");
...
const u8 gText_DadsAdvice[] = _("MOM & DAD's advice echoed…\n“{PLAYER}, there's a time and place for\leverything!”{PAUSE_UNTIL_PRESS}");
...
const u8 gText_UnilimitedRepelEffectsLinger[] = _("But the effects of a DAD's UNLIMITED\nREPEL still linger.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Var1SelenicHowMuch[] = _("A chunk of {STR_VAR_1}?\nCertainly. How much would you like?");
const u8 gText_Var1AndYouWantedVar2[] = _("{STR_VAR_1}? And you wanted {STR_VAR_2}?\nThat will be ¥{STR_VAR_3}.");
const u8 gText_Var1SelenicYouWantVar2[] = _("{STR_VAR_1}… And you want {STR_VAR_2}…\nThat will be ¥{STR_VAR_3}.");
...
const u8 gText_AuroraApex[] = _("AURORA APEX");
...
const u8 gText_ThatsYourLastPkmn[] = _("Can't remove this POKéMON!");
...
const u8 gText_YouCantReleaseAnEgg[] = _("Can't release an EGG.");
...
const u8 gText_Details[] = _("DETAILS");
...
const u8 gText_NormanMatchCallName[] = _("SAMUEL");
const u8 gText_MomMatchCallName[] = _("LAUREN");
...
const u8 gText_Quests[] = _("QUESTS");
...
const u8 gText_SideQuestName_10[] = _("DEVON CORP. Deliveries");
const u8 gText_SideQuestName_11[] = _("High Effort Training");
...
const u8 gText_SideQuestName_16[] = _("The Stolen SUBMARINE");
const u8 gText_SideQuestName_17[] = _("Two Rampant Legends");
const u8 gText_SideQuestName_18[] = _("Aurora Heights");
const u8 gText_SideQuestName_19[] = _("Aurora Borealis");
const u8 gText_SideQuestName_20[] = _("New Stone Chunks");
...
const u8 gText_SideQuestDesc_10[] = _("Perform some deliveries for the DEVON\nCORPORATION, safely and promptly.");
const u8 gText_SideQuestDesc_11[] = _("Bring your first partner to learn the\ntechnique shown on the banners at the\nback of SLATEPORT DOJO.");
const u8 gText_SideQuestDesc_12[] = _("Figure out why a very strange man is\ntrying to continue excavation through\nRUSTURF TUNNEL.");
const u8 gText_SideQuestDesc_13[] = _("Now you've met GABBY & TY, battle\nwith them and show the world your\ntalent. Complete the BIG INTERVIEW!");
const u8 gText_SideQuestDesc_14[] = _("Return home to BOREA GLADE with DAD\nand prepare for the great spectacle\nand test against him!");
const u8 gText_SideQuestDesc_15[] = _("Prevent the rampage an ancient\nPOKéMON from causing harm to the\nHOENN region.");
const u8 gText_SideQuestDesc_16[] = _("Travel to AURORA APEX to try\nand awaken RAYQUAZA!");
const u8 gText_SideQuestDesc_17[] = _("Travel to AURORA APEX to try\nand capture RAYQUAZA!");
const u8 gText_SideQuestDesc_18[] = _("Stay up to date with the new\nstock added to SELENIC SPIRIT.");
...
const u8 gText_SideQuestDoneDesc_2[] = _("You've discovered the legendary\n source of the AURORA BOREALIS!");
const u8 gText_SideQuestDoneDesc_3[] = _("Congratulations!\nYou have been inducted into the\nHALL OF FAME!");
const u8 gText_SideQuestDoneDesc_4[] = _("After learning that QUEEN ABSOL isn't\na danger, but just a messenger, she\nhas joined you in protecting HOENN.");
const u8 gText_SideQuestDoneDesc_5[] = _("You have thwarted TEAM AQUA.");
...
const u8 gText_SideQuestDoneDesc_9[] = _("Congratulations!\nYou have completed the expanded\nPOKéDEX for the POKéMON PROFESSOR!");
const u8 gText_SideQuestDoneDesc_10[] = _("You've made the deliveries for the\nDEVON CORPORATION. In return,\nyou received the EXP. SHARE!");
const u8 gText_SideQuestDoneDesc_11[] = _("Your partner has succesfully learnt\none of the techniques taught at the\nSLATEPORT DOJO.");
const u8 gText_SideQuestDoneDesc_12[] = _("You reunited WANDA and her BOYFRIEND\nand have completed RUSTBORO CITY\nand VERDANTURF TOWN.");
const u8 gText_SideQuestDoneDesc_13[] = _("You've gained masses of notoriety by\nbattling and being interviewed\nby GABBY & TY!");
const u8 gText_SideQuestDoneDesc_14[] = _("After returning home to BOREA GLADE\nyou feel rejuvenated from seeing\nloved ones, once again.");
...
//map
const u8 gText_SideQuestMap[] = _("Map ?");
const u8 gText_SideQuestMapHoenn[] = _("The HOENN Region");
const u8 gText_SideQuestMapBoreaGlade[] = _("BOREA GLADE");
...
const u8 gText_SideQuestRustboroCity[] = _("RUSTBORO CITY");
const u8 gText_SideQuestDewfordTown[] = _("DEWFORD TOWN");
const u8 gText_SideQuestMauvilleCity[] = _("MAUVILLE CITY");
const u8 gText_SideQuestLavaridgeTown[] = _("LAVARIDGE TOWN");
const u8 gText_SideQuestFortreeCity[] = _("FORTREE CITY");
const u8 gText_SideQuestMossdeepCity[] = _("MOSSDEEP CITY");
const u8 gText_SideQuestSootopolisCity[] = _("SOOTOPOLIS CITY");
const u8 gText_SideQuestMapEverGrandeCity[] = _("EVER GRANDE CITY");
const u8 gText_SideQuestMapDewfordSlateport[] = _("DEWFORD TOWN & SLATEPORT CITY");
const u8 gText_SideQuestMapSlateportDojo[] = _("SLATEPORT DOJO");
...
const u8 gText_SideQuestMapRoute131[] = _("ROUTE 131");
...
const u8 gText_SubQuest2_Name10[] = _("Deliver the DEVON GOODS");
const u8 gText_SubQuest2_Name11[] = _("Deliver the LETTER to STEVEN");

const u8 gText_SubQuestAqua_Name1[] = _("Raid in RUSTBORO");
const u8 gText_SubQuestAqua_Name2[] = _("Raid in SLATEPORT");
const u8 gText_SubQuest2_Name14[] = _("Raid in METEOR FALLS");
const u8 gText_SubQuest2_Name15[] = _("Raid on MT. CHIMNEY");

const u8 gText_SubQuest2_Name16[] = _("A Journey Home");
const u8 gText_SubQuest2_Name17[] = _("Help Your Partner Evolve");
...
const u8 gText_SubQuest2_Desc10[] = _("Deliver the DEVON GOODS from the\nworker at the DEVON CORPORATION,\nwho you previously helped.");
const u8 gText_SubQuest2_Desc11[] = _("Deliver a letter to STEVEN from the\nhead of the DEVON CORPORATION,\nMR. STONE.");

const u8 gText_SubQuestAqua_Desc1[] = _("Drive TEAM AQUA out\nof RUSTBORO CITY.");
const u8 gText_SubQuestAqua_Desc2[] = _("Drive TEAM AQUA out\nof SLATEPORT CITY.");
