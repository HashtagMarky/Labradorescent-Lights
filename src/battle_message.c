...
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} has no\nusable POKéMON!\p");
...
static const u8 sText_DontLeaveBirch[] = _("PROF. IGNATIUS: Please!\nPlease don't leave me like this!\p");
...
static const u8 sText_TrainerBlockedBall[] = _("The POKéMON blocked the BALL!");
static const u8 sText_DontBeAThief[] = _("You shouldn't try and catch\nother TRAINER's POKéMON.");
