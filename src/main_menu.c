...
static u32 InitMainMenu(bool8 returningFromOptionsMenu)
{
    ...
    if (returningFromOptionsMenu)
        ...
        BeginNormalPaletteFade(PALETTES_ALL, 0, 0x10, 0, RGB_BLACK); // was fade to white
    ...
    if (!gPaletteFade.active)
    {
        ...
        switch (gTasks[taskId].tMenuType)
        {
            ...
            DISPLAY_HAS_SAVED_GAME_NOPKMN:
                ...
                AddTextPrinterParameterized3(2, FONT_NORMAL, 81, 1, sTextColor_Headers, TEXT_SKIP_DRAW, gText_MainMenuContinue);
            ...
            case HAS_MYSTERY_EVENTS:
                if (CalculatePlayerPartyCount() != 0)
                {
                    ...
                    AddTextPrinterParameterized3(5, 1, 81, 1, sTextColor_Headers, -1, gText_MainMenuContinue);
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_SNORLAX);
...
{
    return CreateMonPicSprite_Affine(SPECIES_SNORLAX, SHINY_ODDS, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
...
static void MainMenu_FormatSavegameTime(u8 hasParty)
{
    ...
    AddTextPrinterParameterized3(2 + 3 * hasParty, FONT_NORMAL, 0, 33, sTextColor_MenuInfo, TEXT_SKIP_DRAW, gStringVar4);
    ptr = ConvertIntToDecimalStringN(str, gSaveBlock2Ptr->playTimeHours, STR_CONV_MODE_LEFT_ALIGN, 3);
    *ptr = 0xF0;
    ConvertIntToDecimalStringN(ptr + 1, gSaveBlock2Ptr->playTimeMinutes, STR_CONV_MODE_LEADING_ZEROS, 2);
    AddTextPrinterParameterized3(2 + 3 * hasParty, FONT_NORMAL, GetStringRightAlignXOffset(FONT_NORMAL, str, 100), 33, sTextColor_MenuInfo, TEXT_SKIP_DRAW, str);
}
...
static void MainMenu_FormatSavegameBadges(void)
{
    ...
    AddTextPrinterParameterized3(5, FONT_NORMAL, 0x6C, 17, sTextColor_MenuInfo, TEXT_SKIP_DRAW, gStringVar4);
    ConvertIntToDecimalStringN(str, badgeCount, STR_CONV_MODE_LEADING_ZEROS, 1);
    AddTextPrinterParameterized3(5, FONT_NORMAL, GetStringRightAlignXOffset(FONT_NORMAL, str, 0xD0), 17, sTextColor_MenuInfo, TEXT_SKIP_DRAW, str);
}
...
static void RenderPlayerParty(void)
{
    ...
    for (i = 0; i < gPlayerPartyCount; i++)
    {
        ...
        id = CreateMonIconNoPersonality(species, SpriteCallbackDummy, 32 * i + 40, 64, 0, 0);
        iconsIDs[i] = id;
