...
{
    [MAPSEC_BOREA_GLADE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_AURORA_APEX] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_AQUAMARINE_ABYSS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_UNDERWATER_AQUAMARINE_ABYSS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_CARNELIAN_CHASM - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
