...
void Task_HandleMultichoiceInput(u8 taskId);
...
void DrawMultichoiceMenu(u8 left, u8 top, u8 multichoiceId, u8 ignoreBPress, u8 cursorPos)
{
...
{
    static const u16 repelItems[] = {ITEM_REPEL, ITEM_SUPER_REPEL, ITEM_MAX_REPEL, ITEM_UNLIMITED_REPEL};
...
static void CreateStartMenuForPokenavTutorial(void)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_MenuOptionPokenav, 8, 41, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_Quests, 8, 89, TEXT_SKIP_DRAW, NULL);
