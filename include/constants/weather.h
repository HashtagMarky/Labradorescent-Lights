...
#define MARINE_CAVE_LOCATIONS_START         (CARNELIAN_CHASM_LOCATIONS_START + CARNELIAN_CHASM_LOCATIONS)
...
#define ABNORMAL_WEATHER_LOCATIONS  (MARINE_CAVE_LOCATIONS + CARNELIAN_CHASM_LOCATIONS)
