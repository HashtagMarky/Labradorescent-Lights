...
#define AQUAMARINE_ABYSS_LOCATIONS_START         (TERRA_CAVE_LOCATIONS_START + TERRA_CAVE_LOCATIONS)
...
#define ABNORMAL_WEATHER_LOCATIONS  (AQUAMARINE_ABYSS_LOCATIONS + TERRA_CAVE_LOCATIONS)
