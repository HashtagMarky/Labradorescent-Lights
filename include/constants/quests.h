...
#define TEAM_AQUA_SUB_COUNT             1
#define TEAM_MAGMA_SUB_COUNT            0
#define FATHERS_REST_SUB_COUNT          0
#define STONE_LETTER_SUB_COUNT          0

#define REMAINING_SUB_COUNT             16
#define SUB_QUEST_COUNT                 (LAB_LIGHTS_SUB_COUNT + SELENIC_SPIRIT_SUB_COUNT + ADVENTURE_BEGINS_SUB_COUNT + POKEDEX_SUB_COUNT + PKMN_LEAGUE_SUB_COUNT + CALAMITY_QUEEN_SUB_COUNT + TEAM_AQUA_SUB_COUNT + TEAM_MAGMA_SUB_COUNT + FATHERS_REST_SUB_COUNT + STONE_LETTER_SUB_COUNT + REMAINING_SUB_COUNT)
