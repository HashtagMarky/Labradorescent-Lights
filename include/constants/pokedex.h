...
enum {
    ...
    NATIONAL_DEX_DEOXYS,
    // PkEDX - If reordering Pokédex, change Set Kanto Scripts and Birch Completion Check
...
enum {
    ...
    HOENN_DEX_SINISTEA,
    HOENN_DEX_JASMIGEIS,
    HOENN_DEX_MATCHAGEIS,
    HOENN_DEX_CHARCADET,
    HOENN_DEX_ARMOROUGE,
    HOENN_DEX_CERULEDGE,
    HOENN_DEX_BASULIN,
    HOENN_DEX_BASULEGION,
    HOENN_DEX_BASULEADER,
    HOENN_DEX_BOLINBAT,
    HOENN_DEX_NOCTEONIX,
    HOENN_DEX_ESPURR,
    HOENN_DEX_MEOWSTIC_FEMALE,
    HOENN_DEX_MEOWSTIC_MALE,
    HOENN_DEX_CHIMCHAR,
    HOENN_DEX_MONFERNO,
    HOENN_DEX_INFERNAPE,
    HOENN_DEX_CARBINK,
...
#define KANTO_DEX_COUNT         NATIONAL_DEX_MEW - NATIONAL_DEX_BULBASAUR + 1
#define JOHTO_DEX_COUNT         NATIONAL_DEX_CELEBI - NATIONAL_DEX_CHIKORITA + 1
#define HOENN_DEX_COUNT         NATIONAL_DEX_JIRACHI - NATIONAL_DEX_TREECKO + 1
